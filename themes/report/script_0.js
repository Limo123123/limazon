        ...
        function renderReport(data) {
            ...
            const html = `
                <div class="bg-white p-10 border-b-8 border-indigo-600 rounded-t-3xl shadow-sm">
                    <div class="flex justify-between items-end">
                        <div>
                            ...
                            <p class="text-xs font-black text-slate-400 uppercase tracking-[0.3em] mt-1">Wirtschafts-Prüfungsbericht</p>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    ...
                    <div class="report-card">
                        <h3 class="text-xs font-bold uppercase text-slate-500 mb-4">Top 10 Vermögensvergleich</h3>
                        <div class="chart-container">
                    ...
                    <table class="w-full text-left text-sm">
                        <thead>
                            <tr class="text-slate-400 border-b border-slate-50">
                                ...
                                <th class="py-3 text-right">Barvermögen</th>
        ...
        function initCharts(data) {
            ...
            new Chart(document.getElementById('moneyChart'), {
                type: 'doughnut',
                data: {
                    labels: ['Nutzervermögen', 'Staatskasse'],
                    datasets: [{
